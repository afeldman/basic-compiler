...
externf = ConstantOperand . C.GlobalReference (ptrType $ FunctionType double [double] False)
...
iconst = ConstantOperand . C.Int 32

fconst :: Double -> Operand
fconst = ConstantOperand . C.Float . F.Double
...
alloca ty = instr (ptrType ty) $ Alloca ty Nothing 0 []
...
-- Import State monad functions
import Control.Monad.State

-- FastMathFlags helper
noFastMathFlags :: FastMathFlags
noFastMathFlags = FastMathFlags False False False False False
